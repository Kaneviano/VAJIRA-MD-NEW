...
global.owner = process.env.OWNER_NUMBER  || '254756429473' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=iRkhkbCJ#QEklz6slrVnIwvOOQyNRU-7uBqd3HgU3lX9auRs7_Nw' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "254756429473" : process.env.MODERATORS ,    
