...
global.owner = process.env.OWNER_NUMBER  || '254712095634' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=7cFVgC5C#WEfJeKq__1s15hbmLWuEBq-BJ1Y0pfstl1pu8UrjKLw' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "254712095634" : process.env.MODERATORS ,    
